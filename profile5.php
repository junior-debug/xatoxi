...
?>
<LINK rel="stylesheet" type="text/css" href="css/services/profile/perfil5.css">
<?php
xpresentationLayer::loaderHeader('userVerification4');
xpresentationLayer::formPerfil4($_SESSION["language"],$_SESSION["id"], "2");
xpresentationLayer::hexagonsPerfil($_SESSION["language"], $_SESSION["id"]);
xpresentationLayer::endHtml();
?>
<script src="./js/services/profile/addressInfoV22.js"></script>
